...
public class AssetManager {
	...
	public static ArrayList<PhysicalObject> physicalObjects;
	public static ArrayList<Sprite> sprites;
	public static ArrayList<Creature> creaturesInBattle;
	...
	public static void init() {
	    ...
	    //INITIALIZE BASE GAME OJECTS
	    int[] points = {20, 56, 28 , 8};
	    player = new Player(20, .5f, "PlayerIdleLeft", "Player", new Transform(0,0), points);
	    camera = new Camera(player.getTransform(), Launcher.width, Launcher.height);
	    //END OF BASE GAME OJECT INITLIZATION
